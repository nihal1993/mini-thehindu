...
$b1 = "SELECT * FROM buisness where id = $id";
$result = mysqli_query($db,$b1);
$bu1=mysqli_fetch_assoc($result);

$id = $_GET['id'];

$ban1 = "SELECT * FROM bangalore where id = $id";
$result = mysqli_query($db,$ban1);
$bang1=mysqli_fetch_assoc($result);
...
{
    $back=' first.php?id=4';
    $front=' first.php?id=6 ';
    $action='first.php?id=5';
}
if($_GET['id'] == 6)
{
    $back=' first.php?id=5';
    $front=' first.php?id=7 ';
    $action='first.php?id=6';
}
if($_GET['id'] == 7)
{
    $back=' first.php?id=6';
    $front=' first.php?id=8 ';
    $action='first.php?id=7';
}
if($_GET['id'] == 8)
{
    $back=' first.php?id=7';
    $front=' first.php?id=9 ';
    $action='first.php?id=8';
}
if($_GET['id'] == 9)
{
    $back=' first.php?id=8';
    $front=' first.php?id=10 ';
    $action='first.php?id=9';
}
if($_GET['id'] == 10)
{
    $back=' first.php?id=9';
    $front=' first.php?id=1 ';
    $action='first.php?id=10';
}
        ...
        <div class="container-fluid " style="text-align: center">
            ...
            <div class="collapse navbar-collapse" >
                <ul style="padding-left:50px;padding-right: 50px; ">
                    ...
                    <li class="nav navbar-left" style="font-size :15px ; font-family:courier;font-weight: bold; "><a href="main.php">/ Buisness-</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-body" style="text-align: justify;text-justify: inter-cluster;">
                    ...
                    <h2 style="text-align: left;padding:5px;color:lightslategrey; " > <?php echo($bu1['header']); ?>  </h2>
                    <hr>
                    <img src="<?php echo($bu1['images']); ?> " class="img-responsive" style="width:600px;height:400px;padding:50px; ">

                    <hr>
                    <div style="text-align: justify;text-justify: inter-word;">
                        <h4 style="text-align:left;padding-left:50px;padding-right:50px;color: darkgrey;   ">
                            <?php echo($bu1['fewline']); ?>
                        </h4>
            ...
            <div >
                <nav style="font-size: 15px;" >
                    <ul class="nav navbar nav-stacked" >
                        <li><a href="first.php?id=9"><?php echo($buu1['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=10"><?php echo($buu2['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=8"><?php echo($buu3['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=7"><?php echo($buu4['header']); ?> </a></li>
                        <hr>
                        <li><a href="first.php?id=5"> <?php echo($buu5['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=4"><?php echo($buu6['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=3"><?php echo($buu7['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=5"> <?php echo($buu8['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=2"> <?php echo($buu9['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=1"><?php echo($buu10['header']); ?></a></li>
