...
$o1 = "SELECT * FROM opinion where id = $id";
$result = mysqli_query($db,$o1);
$op1=mysqli_fetch_assoc($result);
        ...
        <div class="container-fluid " style="text-align: center">
            ...
            <div class="collapse navbar-collapse" >
                <ul style="padding-left:50px;padding-right: 50px; ">
                    ...
                    <li class="nav navbar-left" style="font-size :15px ; font-family:courier;font-weight: bold; "><a href="main.php">/ Opinion-</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-body" style="text-align: justify;text-justify: inter-cluster;">
                    ...
                    <h2 style="text-align: left;padding:5px;color:lightslategrey; " > <?php echo($op1['header']); ?>  </h2>
                    <hr>
                    <img src="<?php echo($op1['images']); ?> " class="img-responsive" style="width:600px;height:400px;padding:50px; ">

                    <hr>
                    <div style="text-align: justify;text-justify: inter-word;">
                        <h4 style="text-align:left;padding-left:50px;padding-right:50px;color: darkgrey;   ">
                            <?php echo($op1['fewline']); ?>
                        </h4>
            ...
            <div >
                <nav style="font-size: 15px;" >
                    <ul class="nav navbar nav-stacked" >
                        <li><a href="first.php?id=10"><?php echo($opp1['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=10"><?php echo($opp2['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=9"><?php echo($opp3['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=8"><?php echo($opp4['header']); ?> </a></li>
                        <hr>
                        <li><a href="first.php?id=7"> <?php echo($opp5['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=6"><?php echo($opp6['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=5"><?php echo($opp7['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=4"> <?php echo($opp8['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=3"> <?php echo($opp9['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=2"><?php echo($opp10['header']); ?></a></li>
