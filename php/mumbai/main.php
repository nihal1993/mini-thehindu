...
<html>
<head>
    <title><?php echo $page5.'|'.$site; ?></title>
                ...
                <div class="container-fluid " style="text-align: center">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <h3 style="text-align:left;color: slategrey">Mumbai news <i class="fa fa-newspaper-o" aria-hidden="true"></i></h3>

                            <hr>
                            <ul class="media-list">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="<?php echo($muu1['images']); ?> " class="media-object  " style="width:500px;">
                                    </div>
                                    <div class="media-body" style="text-align: left;padding: 10px; ">
                                        <h3 class="media-heading"><a href="first.php?id=3"> <?php echo($muu1['header']); ?></a></h3>
                            ...
                            <div class="row" style="padding-top:100px; ">
                                <div class="col-md-10" style="">
                                    <ul class="media-list">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="<?php echo($muu2['images']); ?> " class="media-object" style="width:180px;">
                                            </div>
                                            <div class="media-body" style="text-align: left;padding: 5px; ">
                                                <h4 class="media-heading"><a href="first.php?id=2"> <?php echo($muu2['header']); ?></a></h4>
                                                <p style="font-size: 15px;"><?php echo($muu2['fewline']); ?> </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="<?php echo($muu3['images']); ?> " class="media-object" style="width:180px;">
                                            </div>
                                            <div class="media-body" style="text-align: left;padding: 5px; ">
                                                <h4 class="media-heading"><a href="first.php?id=1"> <?php echo($muu3['header']); ?></a></h4>
                                                <p style="font-size: 15px;"><?php echo($muu3['fewline']); ?> </p>
                                            </div>
                                        </div>
                                        <hr>
