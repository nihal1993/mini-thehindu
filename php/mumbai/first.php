...
$m1 = "SELECT * FROM mumbai where id = $id";
$result = mysqli_query($db,$m1);
$mu1=mysqli_fetch_assoc($result);
        ...
        <div class="container-fluid " style="text-align: center">
            ...
            <div class="collapse navbar-collapse" >
                <ul style="padding-left:50px;padding-right: 50px; ">
                    ...
                    <li class="nav navbar-left" style="font-size :15px ; font-family:courier;font-weight: bold; "><a href="main.php">/ Mumbai-</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-body" style="text-align: justify;text-justify: inter-cluster;">
                    ...
                    <h2 style="text-align: left;padding:5px;color:lightslategrey; " > <?php echo($mu1['header']); ?>  </h2>
                    <hr>
                    <img src="<?php echo($mu1['images']); ?> " class="img-responsive" style="width:600px;height:400px;padding:50px; ">

                    <hr>
                    <div style="text-align: justify;text-justify: inter-word;">
                        <h4 style="text-align:left;padding-left:50px;padding-right:50px;color: darkgrey;   ">
                            <?php echo($mu1['fewline']); ?>
                        </h4>
            ...
            <div >
                <nav style="font-size: 15px;" >
                    <ul class="nav navbar nav-stacked" >
                        <li><a href="first.php?id=3"><?php echo($muu1['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=2 "><?php echo($muu2['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=1 "><?php echo($muu3['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=3 "><?php echo($muu1['header']); ?> </a></li>
                        <hr>
                        <li><a href="first.php?id=2 "> <?php echo($muu2['header']); ?></a></li>
