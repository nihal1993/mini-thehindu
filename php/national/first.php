...
$n2 = "SELECT * FROM articles where id = $id";
$result = mysqli_query($db,$n2);
$na2=mysqli_fetch_assoc($result);
                ...
                <!--main body-->
                    ...
                    <div class="collapse navbar-collapse" >
                        <ul style="padding-left:50px;padding-right: 50px; ">
                            ...
                            <li class="nav navbar-left" style="font-size :15px ; font-family:courier;font-weight: bold; "><a href="main.php">/ National-</a></a></li>
                    ...
                    <h2 style="text-align: left;padding:5px;color:lightslategrey; " > <?php echo($na2['header']); ?>  </h2>
                    <hr>
                    <img src="<?php echo($na2['images']); ?> " class="img-responsive" style="width:600px;height:400px;padding:50px; ">

                    <hr>
                    <div style="text-align: justify;text-justify: inter-word;">
                    <h4 style="text-align:left;padding-left:50px;padding-right:50px;color: darkgrey;   ">
                        <?php echo($na2['fewline']); ?>
                    </h4>
                                ...
                                <div >
                                    <nav style="font-size: 15px;" >
                                        <ul class="nav navbar nav-stacked" >
                                            <li><a href="first.php?id=10"><?php echo($naa1['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=9"><?php echo($naa2['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=8"><?php echo($naa3['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=7"><?php echo($naa4['header']); ?> </a></li>
                                            <hr>
                                            <li><a href="first.php?id=5"> <?php echo($naa5['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=4"><?php echo($naa6['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=3"><?php echo($naa7['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=5"> <?php echo($naa8['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=2"> <?php echo($naa9['header']); ?></a></li>
                                            <hr>
                                            <li><a href="first.php?id=1"><?php echo($naa10['header']); ?></a></li>
