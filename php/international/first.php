...
$in1 = "SELECT * FROM inter where id = $id";
$result = mysqli_query($db,$in1);
$ina1=mysqli_fetch_assoc($result);
        ...
        <div class="container-fluid " style="text-align: center">
            ...
            <div class="collapse navbar-collapse" >
                <ul style="padding-left:50px;padding-right: 50px; ">
                    ...
                    <li class="nav navbar-left" style="font-size :15px ; font-family:courier;font-weight: bold; "><a href="main.php">/ International-</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-body" style="text-align: justify;text-justify: inter-cluster;">
                    ...
                    <h2 style="text-align: left;padding:5px;color:lightslategrey; " > <?php echo($ina1['header']); ?>  </h2>
                    <hr>
                    <img src="<?php echo($ina1['images']); ?> " class="img-responsive" style="width:600px;height:400px;padding:50px; ">

                    <hr>
                    <div style="text-align: justify;text-justify: inter-word;">
                        <h4 style="text-align:left;padding-left:50px;padding-right:50px;color: darkgrey;   ">
                            <?php echo($ina1['fewline']); ?>
                        </h4>
            ...
            <div >
                <nav style="font-size: 15px;" >
                    <ul class="nav navbar nav-stacked" >
                        <li><a href="first.php?id=10"><?php echo($inaa1['header']); ?></a></li>
                        <hr>

                        <hr>
                        <li><a href="first.php?id=9"><?php echo($inaa3['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=8"><?php echo($inaa4['header']); ?> </a></li>
                        <hr>

                        <hr>
                        <li><a href="first.php?id=7"><?php echo($inaa6['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=6"><?php echo($inaa7['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=5"> <?php echo($inaa8['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=4"> <?php echo($inaa9['header']); ?></a></li>
                        <hr>
                        <li><a href="first.php?id=3"><?php echo($inaa10['header']); ?></a></li>
